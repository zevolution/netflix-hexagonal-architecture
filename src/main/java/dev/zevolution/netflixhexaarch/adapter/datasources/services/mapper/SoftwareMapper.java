package dev.zevolution.netflixhexaarch.adapter.datasources.services.mapper;

import dev.zevolution.netflixhexaarch.adapter.datasources.services.data.response.GithubRepoResponse;
import dev.zevolution.netflixhexaarch.adapter.datasources.services.data.response.GitlabProjectResponse;
